...
def register_commands(app):
    ...
    @click.option('--photo', default=5, help='Quantity of photos, default is 30.')
    ...
    def forge(user, follow, photo, tag, collect, comment):
        ...
        from albumy.fakes import fake_admin, fake_comment, fake_follow, fake_photo, real_photo, real_tags, fake_user, fake_collect
